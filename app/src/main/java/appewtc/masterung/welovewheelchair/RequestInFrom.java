...
public class RequestInFrom extends AppCompatActivity {
    ...
    private RadioButton choiceRadio1, choiceRadio2, choiceRadio3, choiceRadio4, choiceRadio5, choiceRadio6, choiceRadio7, choiceRadio8, choiceRadio9, choiceRadio10, choiceRadio11, choiceRadio12, choiceRadio13, choiceRadio14;
    ...
    private boolean checChoose() {
        ...
        bolresult = (choiceRadio1.isChecked() ||
                ...
                (choiceRadio11.isChecked() ||
                        choiceRadio12.isChecked() ||
    ...
    private void bindWidet() {
        ...
        choiceRadio11 = (RadioButton) findViewById(R.id.radioButton13);
        choiceRadio12 = (RadioButton) findViewById(R.id.radioButton14);
        choiceRadio13 = (RadioButton) findViewById(R.id.radioButton15);
        choiceRadio14 = (RadioButton) findViewById(R.id.radioButton9);
    ...
    public void clickBackhome(View view) {
        startActivity(new Intent(RequestInFrom.this, MainActivity.class));
        finish();
    }
} //main class
